...
<ul class="links-group" runat="server" id="offermenu">
	...
	<li><a <%=MyUtils.MenuLink("/Account/Offers?type=Rejected")%> ><span class="icon icon-close"></span> Rejected <span class="mobile-hidden">Offers <span id="menu_Rejected"><%=(u.Rejected==0?"":u.Rejected.ToString())%></span></span> </a></li>
</ul>
